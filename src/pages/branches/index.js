    ...
    <div className="space-y-7 max-w-[90rem]max-w- mx-auto">
      ...
      <div className="grid w-full grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        ...
        <div className="relative w-full mx-auto">
          <a className="relative inline-block w-full transition-transform duration-300 ease-in-out transform hover:-translate-y-2">
            <div className="p-4 bg-white rounded-lg shadow">
              <div className="relative flex justify-center overflow-hidden rounded-lg h-52">
                ...
                <div className="absolute bottom-0 flex justify-center mb-3"></div>
