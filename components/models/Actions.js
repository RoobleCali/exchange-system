              ...
              {({ active }) => (
                <a
                  ...
                  className={classNames(
                    ...
                    "  px-4 py-2 flex  items-center overflow-hidden  justify-center text-sm"
                  )}
                >
                  <XCircleIcon className="w-5 opacity-60 text-red-500" />
                  <span className="ml-2">Cancel Transaction</span>
                </a>
              )}
            </Menu.Item>
            <Menu.Item>
              {({ active }) => (
                <Link href={link}>
                  <a
                    className={classNames(
                      active ? "bg-gray-100 text-gray-900 " : "text-gray-700",
                      "  px-4 py-2 flex   items-center  justify-center text-sm"
                    )}
                  >
